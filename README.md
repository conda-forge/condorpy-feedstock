...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/condorpy-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=15226&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/condorpy-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `condorpy` can be installed with:

```
conda install condorpy
```

It is possible to list all of the versions of `condorpy` available on your platform with:
